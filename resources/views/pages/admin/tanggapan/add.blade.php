...
<main class="h-full pb-16 overflow-y-auto">
  <div class="container px-6 mx-auto grid">
    <h2 class="my-6 text-2xl text-center font-semibold text-gray-700 dark:text-gray-200">
      Berikan Tanggapan Kerusakan Barang
    </h2>
      ...
      <div class="px-4 py-3 mb-8 bg-white rounded-lg shadow-md dark:bg-gray-800">
        <label class="block text-sm">
          ...
          <textarea
            ...
            rows="8" type="text" placeholder="Isi Tanggapan Anda" name="tanggapan" required>{{ $tanggapan ? $tanggapan->tanggapan : '' }}</textarea>

        </label>

        <label class="block mt-4 text-sm">
          <span class="text-gray-700 dark:text-gray-400">Pihak Yang Perbaiki</span>
          ...
          <select
            ...
            <option value="Div.Prasarana Sekolah">Div.Prasarana Sekolah</option>
