<!-- Desktop sidebar -->
<aside class="z-20 hidden w-64 overflow-y-auto bg-gray-600 md:block flex-shrink-0">
  <div class="py-4 text-gray-500 dark:text-gray-400">
  <div class="container mx-auto px-4 mt-6 flex items-center justify-center">
    <img class="bg-center bg-cover" width="70" height="500" src="{{ asset('assets/img/smk8.png')}}" alt="" class="inline-flex ml-3 items-center transform transition hover:scale-125 duration-300 ease-in-out" />
